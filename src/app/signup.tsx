...
const styles = StyleSheet.create({
  ...
  mascot: { width: 65, height: 95 },
  logo: { width: 100, height: 100, marginHorizontal: -4 },
  brand: {
    color: "#9d7aff",
    fontSize: 26,
    fontWeight: "900",
  ...
  subtitle: { color: "#c7d0e8", textAlign: "center", fontSize: 12 },
  sectionLabel: { color: "#fff", fontSize: 11, fontWeight: "900" },
  ...
  selectionHint: { color: "#9af2bc", fontSize: 11 },
  field: { marginTop: 2 },
