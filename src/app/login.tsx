...
const styles = StyleSheet.create({
  ...
  content: { flex: 1, padding: 22, paddingTop: 14, paddingBottom: 20, justifyContent: 'space-between' },
  ...
  brand: { color: '#7564f4', fontSize: 24, fontWeight: '900', textAlign: 'center', marginTop: 0 },
  tagline: { color: '#fff', fontSize: 11, fontWeight: '800', textAlign: 'center', marginTop: 1 },
  grades: { flexDirection: 'row', justifyContent: 'center', gap: 16, marginTop: 12 },
  grade: {
  ...
  title: { color: '#fff', fontSize: 18, fontWeight: '900', marginTop: 16 },
  subtitle: { color: '#c7d0e8', fontSize: 11, marginTop: 2 },
  field: { marginTop: 10 },
  ...
  forgot: { color: '#817af0', fontSize: 10, fontWeight: '800', textAlign: 'right', marginTop: 6 },
  primary: { backgroundColor: '#5857e4', borderRadius: 9, alignItems: 'center', padding: 11, marginTop: 14 },
  ...
  footer: { color: '#fff', textAlign: 'center', marginTop: 12, fontWeight: '800' },
